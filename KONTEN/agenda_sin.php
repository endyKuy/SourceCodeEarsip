            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-secondary topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav mr-auto ml-md-3 my-2 my-md-0">
                        <a class="nav-link disabled" style="font-size: 17px; color: white;">
                            <i class="fas fa-fw fa-bookmark"></i><b>Agenda Surat Masuk</b>
                        </a>
                    </ul>
                ...
                <div class="container-fluid">
                    <div class="card-shadow">
                        <div class="card-body">
                            <form method="POST" style="margin-left: 108px; margin-bottom: 30px;" action="">
                                <div class="row">
                                    <div>
                                        <h4>Masukan Tanggal :</h4>
                                    </div>
                                    <div class="col-lg-3">
                                        <input type="date" name="tgl_awl" class="form-control">
                                    </div>
                                    <div>
                                        <h3>s/d</h3>
                                    </div>
                            ...
                            <div class="table">
                                ...
                                <form action="cetaksin.php" method="POST" class="d-flex justify-content-center">
                                    <?php
                                    if (isset($_POST['filter'])) {
                                    $tgl_awl = mysqli_real_escape_string($koneksi, $_POST['tgl_awl']);
                                    $tgl_akhir = mysqli_real_escape_string($koneksi, $_POST['tgl_akhir']);?>
