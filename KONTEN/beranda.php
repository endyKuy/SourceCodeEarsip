            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-secondary topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav mr-auto ml-md-3 my-2 my-md-0">
                        <a class="nav-link disabled" style="font-size: 17px; color: white;">
                            <i class="fas fa-fw fa-bookmark"></i><b>Beranda</b>
                        </a>
                    </ul>
                ...
                <div class="container-fluid">
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        Hai <strong><?=$username?></strong> Semoga hari-mu menyenangkan...
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-capitalize font-weight-bold text-success mb-1">
                                                Surat Masuk</div>
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-caret-down fa-3x text-success"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-capitalize font-weight-bold text-danger mb-1">
                                                Surat Keluar</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    require_once 'koneksi.php';
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-caret-down fa-rotate-180 fa-3x text-danger"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-capitalize font-weight-bold text-info mb-1">
                                                User</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    require_once 'koneksi.php';
