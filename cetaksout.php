...
$pdf->Cell(146,10,'Agenda Surat Keluar Dari Tanggal : ' ,0,0,'R');
...
$pdf->Cell(60,10,'TUJUAN SURAT',1,0,'C');
$pdf->Cell(25,10,'TGL. SURAT',1,0,'C');
$pdf->Cell(25,10,'TGL. KIRIM',1,0,'C');
    ...
    while ($d = mysqli_fetch_array($sql)) 
{
  ...
  $pdf->Cell(60,6, $d['tujuan_surat'],1,0,'C');
  $pdf->Cell(25,6, $d['tgl_surat'],1,0,'C');
  $pdf->Cell(25,6, $d['tgl_kirim'],1,0,'C');
