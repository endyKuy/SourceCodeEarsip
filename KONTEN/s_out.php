                ...
                <nav class="navbar navbar-expand navbar-light bg-secondary topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav mr-auto ml-md-3 my-2 my-md-0">
                        <a class="nav-link disabled" style="font-size: 17px; color: white;">
                            <i class="fas fa-fw fa-bookmark"></i><b>Surat Keluar</b>
                        </a>
                    </ul>
                                     ...
                                     <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="index.php?page=dels_out&no=<?=$b['no_surat']?>" class="btn-sm btn-danger p-1" style="cursor: pointer; text-decoration: none;" onclick="return confirm('Hapus Data?')"><i class="fas fa-trash p-1"></i></a>
                                            </td>
                                        </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="index.php?page=edit_sout" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-9 mb-3">
                            <label for="formGroupExampleInput2">Tujuan Surat</label>
                            <input type="text" class="form-control" name="tujuan_surat" value="<?=$b['tujuan_surat']?>">
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="formGroupExampleInput2">Tanggal Kirim Surat</label>
                            <input type="date" class="form-control" name="tgl_kirim" value="<?=$b['tgl_kirim']?>">
                        </div>
                    </div>
    ...
    <div class="modal fade" id="inputModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="index.php?page=saves_out" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label for="formGroupExampleInput2">No. Surat</label>
                    ...
                    <div class="form-row">
                        <div class="col-md-3 mb-3">
                            <label for="formGroupExampleInput2">Jenis Surat</label>
                            <select name="jns_surat" id="" class="form-control" required="">
                            <option>(Pilih)</option>
                            <option value="Pribadi">Pribadi</option>
                            <option value="Dinas">Dinas</option>
                            <option value="Niaga">Niaga</option>
